...
Compreender os fundamentos do Arduino, configurar o ambiente de simulação virtual no Tinkercad, aprender a manipular pinos digitais de saída e utilizar o GitHub para o controle de versão e documentação do projeto.
